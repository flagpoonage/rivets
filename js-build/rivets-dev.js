(function () {
    ...
    Rivets.View = (function () {
        ...
        View.prototype.destroy = function () {
            this.unbind();
            this.models = null;
            for (var _i = 0, _len = this.bindings.length; _i < _len; _i++) {
                binding = this.bindings[_i];
                binding.destroy();
            }
        };
    ...
    Rivets.Binding = (function () {
        ...
        Binding.prototype.setObserver = function () {
            this.observer = new Rivets.KeypathObserver(this.view, this.view.models, this.keypath, (function (_this) {
                return function (obs) {
                    if (_this.key) {
                        _this.unbind(true);
                    }
        ...
        Binding.prototype.bind = function (silent) {
            ...
            if ((_ref1 = this.options.dependencies) != null ? _ref1.length : void 0) {
                ...
                for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
                    dependency = _ref2[_i];
                    observer = new Rivets.KeypathObserver(this.view, this.model, dependency, (function (_this) {
                        return function (obs, prev) {
                            var key;
                            key = obs.key;
        ...
        Binding.prototype.destroy = function () {
            var _ref;
            if ((_ref = this.binder.destroy) != null) {
                _ref.call(this);
            }
            this.model = null;
            if ((_ref = this.observer.destroy) != null) {
                _ref.call(this);
            }
        }
    ...
    Rivets.ComponentBinding = (function (_super) {
        ...
        ComponentBinding.prototype.destroy = function () {
            console.log('Component binding destroy called.');
        }
    ...
    Rivets.KeypathObserver = (function () {
        ...
        KeypathObserver.prototype.destroy = function () {
            var _ref = this.objectPath;
            this.target = null;
            this.model = null;
    ...
    Rivets.binders['each-*'] = {
        ...
        destroy: function () {
            var _iterated = this.iterated;
            for (var i = 0; i < _iterated.length; i++) {
                _iterated[i].destroy();
            }
            console.log('Each-* binding destroy called.');
        }
    };
    ...
    // James Hay 12/06/2014
    // Backbone adapter for data bindings
    ...
    // James Hay 12/06/2014
    // Simple template loader/retriever/binder
    // NOTE: Use tBind instead of default bind.
    Rivets.templates = {
        _tpl: {},
        extract: function (id) {
            var dt = 'data-template';
            if (!_.isUndefined(id)) {
                var s = $('script[' + dt + '="' + id + '"]');
                this._tpl[id] = s.html();
                s.remove();
        ...
        tBind: function (id, data, options) {
            var tpl = this.retrieve(id);
            return rivets.bind(tpl, data, options);
        }
    }
    ...
    Rivets.factory = function (exports) {
        ...
        exports.templates = Rivets.templates;
